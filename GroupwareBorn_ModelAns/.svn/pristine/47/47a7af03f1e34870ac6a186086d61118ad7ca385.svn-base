...
<body>
	<div id="base">
		...
		<div id="contents">
			...
			<form:form modelAttribute="facilityFormSession" action="/facility/complete"
				method="post">
				...
				<input type="hidden" id="typeId" name="typeId"
					value="${facilityFormSession.typeId}" />
				...
				<input type="button" class="back"value="戻る" onClick="location.href='/facility/back/${btnAction}'"/>
			</form:form>
		</div>
		<div id="footer">
