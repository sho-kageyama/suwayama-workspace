...
public class FacilityServiceImp implements FacilityService {
	 ...
	 * @return repoFacility
	 */
	public FacilityRepository getRepoFacility() {
		return repoFacility;
	}

	/**
	 * @param repoFacility セットする repoFacility
	 */
	public void setRepoFacility(FacilityRepository repoFacility) {
		this.repoFacility = repoFacility;
	}
